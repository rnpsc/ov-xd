            ...
            <div class="topBar-wrapper">
                <div class="topBar-leftWrapper">
                    <div class="selectAppModule-wrap d-flex toggleDrawer align-items-center">
                        ...
                        <div class="selectedAppModule">Sunfire GmbH <i class="far fa-angle-down d-none d-md-inline-block"></i></div>
                    </div>
                </div>
            ...
            <div class="contentWrapper-right">
                <div class="secondaryActions">
                    <button class="secondaryActions-button">
                        ...
                        <span class="secondaryActions-lable">Gliederung <i class="far fa-angle-down "></i></span>
                    </button>
                    <button class="secondaryActions-button">
                ...
                <div class="structureWrapper">
                    <div class="modal-body explorer-body bg-white pr-2 scrollarea">
...
<div class="modalDrawer ">
    <div class="drawerHead pl-3 pl-md-4 pr-2 pr-md-3 ">
        <div class="logo">
    ...
    <div class="drawerBody ">
            <div class="item px-3 px-md-4 py-3 d-md-none mb-3" style="border:none">
    ...
    <div class="drawerFooter">
        <div class="item px-3 px-md-4 py-4"><i class="fas fa-cogs mr-2"></i>Einstellungen</div>
    </div>
</div>
