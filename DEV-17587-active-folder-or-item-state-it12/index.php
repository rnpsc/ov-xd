            ...
            <div class="contentWrapper-left">
                <div class="contentWrapper-left-sticky-header">
                    <div class="breadcrumb-modeSwitch-wrapper">
                        <!-- BREADCRUMB -->
                        <div class="breadcrumb"><a href="#"><i class="fa-solid fa-home"></i></a>&nbsp;&nbsp;›&nbsp;&nbsp;<a href="#">Innovation und Technologie</a>&nbsp;&nbsp;›&nbsp;&nbsp;<a href="#">Learning Network</a>&nbsp;&nbsp;›&nbsp;&nbsp;<a href="#">A long title to bring the message home</a>&nbsp;&nbsp;›&nbsp;&nbsp;<a href="#">Some other ABC item</a>&nbsp;&nbsp;›&nbsp;&nbsp;<a href="#" class="active">Neuigkeiten</a>   </div>
                        <!-- BREADCRUMB -->
                        <div class="mode-switch " style="display: flex; align-items: center" tabindex="0" role="button"  >
