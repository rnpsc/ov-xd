...
<head>
    ...
    <title>Prototyp - 15</title>

    <link rel="stylesheet" href="css/grid.css?<?php echo time() ?>">
    ...
    <link rel="stylesheet" href="css/mdc.css?<?php echo time() ?>">
            ...
            <div class="contentWrapper-left">
                <div class="contentWrapper-left-sticky-header">
                    <div class="breadcrumb-modeSwitch-wrapper">
                        <!-- BREADCRUMB -->
                        <div class="breadcrumb"><a href="#"><i class="fa-solid fa-home"></i></a><i class="fa-solid fa-angle-right mx-2"></i><a href="#">Innovation und Technologie</a>&nbsp;&nbsp;›&nbsp;&nbsp;<a href="#">Learning Network</a>&nbsp;&nbsp;›&nbsp;&nbsp;<a href="#">A long title to bring the message home</a>&nbsp;&nbsp;›&nbsp;&nbsp;<a href="#">Some other ABC item</a>&nbsp;&nbsp;›&nbsp;&nbsp;<a href="#" class="active">Neuigkeiten</a>   </div>
                ...
                <div class="contentWrapper-left-scroll-area-barrier">
                    <div class="contentWrapper-left-scroll-area-child">
                        ...
                        <!-- ARTICLE ITEM -->
                        <div class="article-item hasTransition networkParticipant-item" tabindex="0" id="person">
                            ...
                            <div class="article-wrapper-head-body">
                                ...
                                <div class="teasertext networkParticipant-item memberContact-item closed">
                                    <div class="memberContact-grid d-none">
                                        <div class="column">E-Mail</div>
                                        <div class="column">meineadresse@gridfractions.com</div>
                                        <div class="column">
                                            <div class="memberContact-profileImage radi-100 radi-sm-5" style="background-image: url(img/woman-3.png)"></div>
                                        </div>
                                    </div>
                                            ...
                                            <div class="teasingRow d-flex flex-row flex-md-row flex-grow-1 flex-wrap">
                                                <div class="memberContact-profileData-wrap mb-2 mb-md-0" >
                                                    <div class="memberContact-profileData-row d-flex  flex-wrap flex-sm-nowrap ">
                                                        ...
                                                        <div class="memberContact-profileData-value d-flex flex-grow-1 justify-content-end justify-content-sm-start align-items-center  "><a href="#">ellen.schilling@greenleaf.io</a></div>
                                                    </div>
                                                    <div class="memberContact-profileData-row d-flex  flex-wrap">
                                                        ...
                                                        <div class="memberContact-profileData-value d-flex flex-grow-1 justify-content-end justify-content-sm-start align-items-center  "><span class="nowrap">+49 (0)30 33 44 55 66</span></div>
                                                    </div>
                                                    <div class="memberContact-profileData-row d-flex border-none flex-wrap">
                                                        ...
                                                        <div class="memberContact-profileData-value d-flex flex-grow-1 justify-content-end justify-content-sm-start align-items-center ">Geschäftsführerin</div>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="memberContact-profileImage-wrap d-flex flex-grow-0 align-content-start justify-content-center justify-content-md-start pt-2 pr-0 pb-2 pl-3 pt-md-3 pr-md-0 pb-md-0 pl-md-3 ml-sm-3 mr-md-0 ">
                                            <div class="memberContact-profileImage radi-8 radi-sm-4" style="background-image: url(img/woman-3.png)"></div>
                                        </div>
                                    </div>
                                    <div class="additionalInformation d-flex flex-column flex-sm-row mt-3 flex-grow-1 flex-wrap ">
                                                ...
                                                <div class="teasingRow d-flex flex-row flex-md-row flex-grow-1 flex-wrap">
                                                    <div class="memberContact-profileData-wrap mb-2 mb-md-0" >
                                                        <div class="memberContact-profileData-row d-flex flex-wrap flex-sm-nowrap ">
                                                            ...
                                                            <div class="memberContact-profileData-value d-flex flex-grow-1 justify-content-end justify-content-sm-start align-items-center  ">Geschäftsführung</div>
                                                        </div>
                                                        <div class="memberContact-profileData-row d-flex flex-wrap">
                                                            <div class="memberContact-profileData-label d-flex flex-grow-0 justify-content-start align-items-center mr-0 mr-sm-3"><span class="nowrap d-none d-sm-flex">Telefax</span><span class="mobileLabel d-flex align-items-center d-sm-none bg night-200 font-night-600 radi-3">Telefon</span></div>
                                                            <div class="memberContact-profileData-value d-flex flex-grow-1 justify-content-end justify-content-sm-start align-items-center  "><span class="nowrap">+49 (0)30 33 44 55 67</span></div>
                                                        </div>
                                                        <div class="memberContact-profileData-row d-flex flex-wrap">
                                                            <div class="memberContact-profileData-label d-flex flex-grow-0 justify-content-start align-items-center mr-0 mr-sm-3" ><span class="nowrap d-none d-sm-flex">Mobil</span><span class="mobileLabel d-flex align-items-center d-sm-none bg night-200 font-night-600 radi-3">Position</span></div>
                                                            <div class="memberContact-profileData-value d-flex flex-grow-1 justify-content-end justify-content-sm-start align-items-center ">+49  (0)171 44 66 88</div>
                                                        </div>
                                                        <div class="memberContact-profileData-row d-flex  flex-wrap flex-sm-nowrap ">
                                                            ...
                                                            <div class="memberContact-profileData-value d-flex flex-grow-1 justify-content-end justify-content-sm-start align-items-center text-align-right text-align-sm-left">Rudi-Dutschke-Str. 202<br>10117, Berlin<br>Deutschland</div>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                    ...
                                    <div class="roleInformation additionalInformation d-flex flex-column flex-sm-row mt-4 flex-grow-1 flex-wrap ">
...
<script>
    $('.networkParticipant-item .fa-square-caret-down').click(function(){
        $('.memberContact-item ').toggleClass("closed");
    });
</script>
<!-- -->
<!-- -->
