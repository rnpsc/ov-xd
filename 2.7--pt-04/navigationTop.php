...
<head>
    ...
    <title>Prototype - 14 - navTop</title>
...
<body class="r navigationTop">
<div class="outerWrapper">
    <!-- HEADER -->
    <!-- HEADER -->
    <!-- HEADER -->
    <div class="header ">
        <div class="topBar px-3 px-md-4">
            <div class="topBar-wrapper">
                <div class="topBar-leftWrapper">
                    <div class="selectAppModule-wrap d-flex toggleDrawer align-items-center">
                ...
                <div class="topBar-rightWrapper d-flex align-items-center">
                    ...
                    <div class="account"  tabindex="0" role="button" >
                        <div class="accountName returnCSS d-none d-md-block ">Mareike Thomas</div>
        ...
        <div class="navigationHeader d-flex d-md-none px-0">
            <div class="navigationHeader-wrapper">
                <div class="secondaryActions py-1 px-1">
                    <div class="menuItem tasks mx-1 px-2 py-1" tabindex="0">
                        <i class="far  fa-check-square mr-1"></i>
                        <span class="menuItem-label">Aufgaben</span>
                    </div>
                    <div class="menuItem information mx-1 px-2 py-1" tabindex="0">
                        <i class="far  fa-info-circle mr-1"></i>
                        <span class="menuItem-label">Information</span>
                    </div>

                    <div class="menuItem mx-1 px-2 py-1 toggleTree" tabindex="0">
                        <i class="far  fa-stream mr-1"></i>
    ...
    <div class="content">
        <div class="contentWrapper">
            ...
            <div class="contentWrapper-right">
                <div class="secondaryActions d-none d-md-flex">
...
<script>
    $('.toggleDrawer').click(function () {
        ...
        $('.treeBackDrop').removeClass("open");
        $('.tasks').removeClass("inactive");
        $('.information').removeClass("inactive");
        $('.contentWrapper-right').removeClass("open");
    });
</script>
<!-- -->
<!-- -->
